-- Fixed wrapper functions with correct PostgreSQL syntax
-- The DECLARE statements need to be at the beginning of the function

-- Create wrapper function with correct syntax
