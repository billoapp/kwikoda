    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-4">
          {isOnline ? 'Connection Restored' : 'Staff Dashboard Offline'}
        </h1>
        
        <p className="text-gray-600 mb-8">
          {isOnline 
            ? 'Your internet connection is back. You can continue managing tabs.'
            : 'Please check your internet connection to access the staff dashboard.'
          }
        </p>
        ...
        {!isOnline && (
          <div className="mt-8 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-800">
              ...
              • Access cached customer data<br />
              • View recent orders
            </p>
          </div>
        )}
